...
export default function ContactPage() {
  return (
    <>
      {/* ── Mini hero ────────────────────────────────────────────────────── */}
      <section
        className="bg-hero text-white pt-36 pb-20 md:pt-44 md:pb-24 relative overflow-hidden"
        ...
        <div className="container-main relative">
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
                ...
                {CONTACT_METHODS.map((method) => (
                  <div key={method.label} className="flex items-center gap-4">
                    <div className="flex items-center justify-center w-10 h-10 bg-brand-500/10 border border-brand-500/20 rounded-xl shrink-0">
                      <method.icon className="w-5 h-5 text-brand-400" aria-hidden />
                    </div>
                    <div>
            ...
            <div className="glass rounded-2xl p-8 md:p-10">
              <h2 className="text-lg font-bold text-white mb-1">Envoyer un message</h2>
